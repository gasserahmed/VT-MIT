...
public class LinkedPipeTest {
	...
	public void testHashCodeABC6AndAB6() {
		...
		assertFalse(linked_ABC_6.hashCode() == linked_AB_6.hashCode());
	}
	...
	public void testHashCodeABC6AndDifferentABC6() {
		...
		assertTrue(linked_ABC_6.hashCode() == linked_ABC_6_dup.hashCode());
	}
	...
	public void testHashCodeABC6AndABC10() {
		...
		assertFalse(linked_ABC_6.hashCode() == linked_ABC_10.hashCode());
	}
	...
	public void testHashCodeABC6ArrayBasedAndABC6LinkedBased() {
		...
		assertTrue(linked_ABC_6.hashCode() == pipe_ABC_6_array.hashCode());
	}
	...
	public void testHashCodeABC6ListBasedAndABC6LinkedBased() {
		...
		assertTrue(linked_ABC_6.hashCode() == pipe_ABC_6_list.hashCode());
	}
	...
	@Test
	public void testEmptyAppendLinked() {
		linked_empty_3.append(linked_ABC_6);
		String emptyResult = "";
		for (String s : linked_empty_3) {
			if (s != null) {
				emptyResult += s;
	...
	@Test
	public void testEmptyAppendLinkedWhenFull() {
		testEmptyAppendLinked();
		LinkedPipe<String> testList = new LinkedPipe<String>(2);
		testList.append("X");
		testList.append("Y");
		linked_empty_3.append(testList);
		String emptyResult = "";
		for (String s : linked_empty_3) {
			if (s != null) {
				emptyResult += s;
