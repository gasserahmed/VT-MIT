...
/**
 * <p>
 * A bounded data structure. Elements in the pipe may not be null.
 * </p>
 * 
 * <p>
 * A typical string representation of a bounded pipe is
 * <code>[e_1, e_2, ..., e_n-1, e_n]:c</code>, where <code>e_1</code> is the
 * first element of the pipe and <code>e_n</code> is the last element, and
 ...
 * strictly greater zero.
 * </p>
 * <p>
 * <code>public Pipe(int max)</code>
 * </p>
 * <p>
...
public interface Pipe<E> extends Iterable<E> {
    ...
    /**
     * Returns a copy of this pipe. The elements in the copy are references to
     * the elements in this pipe.
     * 
    ...
    /**
     * Returns the first element of this pipe.
     * 
     * @return the first element of this pipe
     */
    public E first();
    ...
    /**
     * Returns the last element of this pipe.
     * 
     * @return the last element of this pipe
     */
    public E last();
    ...
    /**
     * Returns true if the specified object is equal to this pipe. To be equal,
     * the specified object must be a bounded pipe with the same capacity, and
     * it must contain the same number of elements with the same values in the
     * same order.
     * 
     * @param obj the object to be tested for equality to this pipe
     * @return true if the specified object is equal to this pipe, false
     *         otherwise
     */
    @Override
    ...
    /**
     * Returns the string representation of this pipe. The string representation
     * contains a list of this pipe's element from start to end and the pipe's
     * capacity. The list is enclosed in square brackets and adjacent elements
     * are separated by a comma and a space. The list and capacity are separated
     * by a colon. For example, the string <code>[A, B, C]:6</code> represents a
     * pipe with 3 elements, where A is start element, C is the last element,
     * and the pipe has a capacity of 6.
     * 
