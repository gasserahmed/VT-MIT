...
def feature_extract():
    ...
    DIR_wh = 's3://ece5984-bucket-gasser18/Lab3'                                 # Insert here
    ...
    feature_transform_amzn = pd.DataFrame(columns=features, data=feature_transform_amzn, index=amzn_df.index)
